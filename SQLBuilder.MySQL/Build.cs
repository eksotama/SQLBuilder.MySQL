...
using SQLBuilder.MySQL.Builder;
...
namespace SQLBuilder.MySQL {
    ...
    public static class Build {
        ...
        public static InsertQuery Insert(string Database, string Table) {
            return new InsertQuery(Database, Table);
        }
        ...
        public static UpdateQuery Update(string Database, string Table) {
            return new UpdateQuery(Database, Table);
        }
        ...
        public static DeleteQuery Delete(string Database, string Table) {
            return new DeleteQuery(Database, Table);
        }
    }
}
