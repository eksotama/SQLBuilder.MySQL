...
namespace SQLBuilder.MySQL.Builder {
    ...
    public class SelectCountQuery : BaseQuery {
        ...
        private double _LimitOffset { get; set; }
        ...
        /// </summary>
        /// <param name="Offset">The offset limit.</param>
        /// <param name="RowCount">The row count limit.</param>
        /// <returns>The current instance of this class.</returns>
        public SelectCountQuery SetLimit(double Offset, double RowCount) {
        ...
        /// <param name="RowCount">The row count limit.</param>
        /// <returns>The current instance of this class.</returns>
        public SelectCountQuery SetLimit(double RowCount) {
        ...
        public override string ToString() {
            ...
            if (this._LimitRowCount > 0) {
                if (this._LimitOffset > 0) {
                    sb.Append(String.Format("\nLIMIT {0}, {1}", this._LimitOffset, this._LimitRowCount));
                } else {
                    sb.Append(String.Format("\nLIMIT {0}", this._LimitRowCount));
                }
            }
